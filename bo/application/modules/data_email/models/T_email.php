...
class T_email extends CI_Model
{
	...
	{
		$this->db->select("email.*, ckt.email, ckt.nama, CASE WHEN email.id_checkout is null THEN 'Manual' ELSE 'Konfirmasi' END as tipe_kirim");
			...
			if($_POST['search']['value']) 
			{
				...
				else
				{
					if($item == 'tipe_kirim') {
						 ...
						 */
						$this->db->or_like('(CASE WHEN email.id_checkout is null THEN \'Manual\' ELSE \'Konfirmasi\' END)', $_POST['search']['value'],'both',false);
					}
					else{
