  ...
  <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
      ...
      <div class="alert alert-light alert-elevate" role="alert">
        ...
        <div class="alert-text alert-dismissible">
            Mohon Konfirmasi Pembayaran dan Mengirim Pemberitahuan Kepada Member.
        </div>
      </div>
    ...
    <div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="kt-portlet__body">
        ...
        <form class="form-edit-role kt-form" id="form-konfirmasi">
              ...
              <input type="hidden" value="<?php echo $kode_aff;?>" name="kode_aff">
                ...
                <div class="form-group row">
                  <label class="control-label col-sm-5"><strong>Link Affiliate (Link ini akan diberikan ketika transaksi dikonfirmasi)</strong></label>
                  <label class="control-label col-sm-7">: <strong><?= $link_affiliate; ?></strong></label>
                </div>
