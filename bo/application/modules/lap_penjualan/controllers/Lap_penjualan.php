...
class Lap_penjualan extends CI_Controller {
	...
	public function export_excel()
	{
		...
		$data['tes'] = $this->t_checkout->get_data_laporan($tgl_awal_fix, $tgl_akhir_fix);

		// var_dump($data['tes']); die();
		...
		$content = [
			...
			'modal' => null,
			'js'	=> 'lap_penjualan.js',
			'view'	=> 'view_cetak_excell'
		];

		$this->load->view('Lap_penjualan/view_cetak_excell', $data);
