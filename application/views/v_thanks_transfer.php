    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="media text-muted pt-3">
          <h2 class="text-primary">Terima kasih, Atas pembayaran anda</h2>
        </div>
        <div class="media text-muted">
          <p><h5 class="text-secondary">Silahkan ke Member Area untuk melihat Profil anda.</h5></p>
        </div>  
      </div>
    </div>
...
<svg class="bi" width="21" height="21" fill="#007bff">
    ...
    <a href="<?= base_url('profile')?>" class="btn btn-block btn-primary">Lihat Profil anda disini </a>
